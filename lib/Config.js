...
class Config {
  ...
  get notifyUpdate() {
    return this.conf.get("notifyUpdate");
  }

  set notifyUpdate(value) {
    this.conf.set("notifyUpdate", value);
  }

  get skipPrivateOrDeleted() {
    return this.conf.get("skipPrivateOrDeleted");
  }

  set skipPrivateOrDeleted(value) {
    this.conf.set("skipPrivateOrDeleted", value);
  }
